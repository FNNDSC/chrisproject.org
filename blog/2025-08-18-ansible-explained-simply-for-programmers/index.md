...
Python 2. I noticed right away that its developer experience today indeed
feels like decade-old Python software:

- It's slow.
- Error messages are usually hard-to-read.
- Limited tools for static analysis: you don't know if a playbook will do what
  you expect it will until you run it.

Furthermore, its own claims to fame are stretched truths:
